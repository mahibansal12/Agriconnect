...
function AdminDashboard() {
  ...
  const farmerCount = adminUsers.filter((u) => u.role === "farmer").length;
  const buyerCount = adminUsers.filter((u) => u.role === "buyer").length;
      ...
      <div className="adm-main">
        ...
        <main className="adm-content">
          ...
          <div className="adm-stats-grid">
            <StatCard icon={<Icon.users width={18} height={18} />} label="Total Users" value={adminUsers.length} accent="green" />
            <StatCard icon={<Icon.listings width={18} height={18} />} label="Pending Listings" value={pendingListings.length} accent="amber" />
          ...
          <div className="adm-card">
              ...
              <>
                ...
                <div className="adm-quick-grid">
                  ...
                  <div className="adm-quick-item adm-quick-item--gold">
                    ...
                    <span className="adm-quick-value">{pendingListings.length}</span>
                  </div>
                  <div className="adm-quick-item adm-quick-item--green">
            ...
            {activeTab === "users" && (
              <>
                <SectionHeader title="Users" subtitle={`${adminUsers.length} registered accounts`} />
